...
#Script Instagram
                ...
                if len(arg) > 1:
                    ...
                    cl.sendText(msg.to,"Contoh /ig nughiroyale") 
#--------------------------------------------------------
#Script Twitter
...
#Search,Add and Steal By Id and Mid
              ...
              if msg.from_ in admin:
                ...
                if msg.from_ in admin:
                	cl.sendText(msg.to,"「Aʙᴏᴜᴛ Bᴏᴛ」\nŘØ¥ΔŁ€ Ŧ€ΔΜ ƤŘØŦ€ĆŦ Sᴇʟғʙᴏᴛ\nTɪᴍᴇ: " + datetime.today().strftime('%H:%M:%S') + " \n\n「Bᴏᴛ Iɴғᴏʀᴍᴀᴛɪᴏɴ」\n╠═════════════════════\n  ❂͜͡➣ Bᴏᴛ Cʀᴇᴀᴛᴇᴅ ɪɴ: 11-12-2017\n  ❂͜͡➣ Bᴏᴛ Uᴘʟɪɴᴋ ʙʏ: Nughi\n「 ▶ line://ti/p/~nughiroyale」\n  ☸ Bᴏᴛ Usᴇʀɴᴀᴍᴇ: Royale \n  ☸ Exᴘɪʀᴇᴅ ᴅᴀᴛᴇ: 01-05-2019\n  ☸ Iɴ ᴅᴀʏs: 300+ ᴅᴀʏs\n╠═════════════════════\n「Cᴏɴᴛᴀᴄᴛ Pᴇʀsᴏɴᴀʟ」\n「 ▶ ID LINE: line://ti/p/~nughiroyale」\n\n ŘØ¥ΔŁ€ Ŧ€ΔΜ ƤŘØŦ€ĆŦ")
